 ...
 'blocks': [{'type': 'text',
            ...
            {'type': 'text',
             'value': {'de': '## Permission-Modi\n'
                             ...
                             'normale Modus fragt nach, der Plan-Modus ändert gar nichts, '
                             'Auto-Accept übernimmt Edits. Für unbeaufsichtigte Läufe gibt es '
                       ...
                       'en': '## Permission Modes\n'
                             ...
                             'normal mode asks for confirmation, plan mode changes nothing at all, '
                             'auto-accept takes over edits. For unattended runs there is a '
            ...
            {'type': 'text',
             'value': {'de': '## Sandboxing\n'
                             ...
                             'über Einstellungen (`sandbox.enabled`).\n'
                             '\n'
                       ...
                       'en': '## Sandboxing\n'
                             ...
                             "effect within a limited scope. It's enabled via settings "
                             '(`sandbox.enabled`).\n'
                             '\n'
            ...
            {'type': 'text',
             'value': {'de': '## Enterprise: Managed Settings\n'
                             ...
                             '(`permissions.deny`)\n'
                             '- Sandbox erzwingen — gehört in: Managed Settings '
                             '(`sandbox.enabled`)\n'
                       ...
                       'en': '## Enterprise: Managed Settings\n'
                             ...
                             '(`permissions.deny`)\n'
                             '- Enforce sandbox — belongs in: Managed Settings '
                             '(`sandbox.enabled`)\n'
